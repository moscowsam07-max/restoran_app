              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    await showDialog(
                      ...
                      builder: (alertDialogContext) {
                        return AlertDialog(
                          title: Text('Xavfsizlik Yangilandi! 🔒'),
                          content: Text(
                              'Sizning yangi login va maxfiy parolingiz tizim xotirasiga 100% xavfsiz muhrlandi!'),
                          actions: [
                            TextButton(
                              onPressed: () =>
                  ...
                  text: FFLocalizations.of(context).getText(
                    'y6rh0sy8' /* O'zgarishlarni saqlash */,
                  ),
